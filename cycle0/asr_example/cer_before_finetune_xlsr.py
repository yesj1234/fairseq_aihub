...
if __name__ == "__main__":
    ...
    # parser.add_argument("--lang", default="en", help="language code for datasets")    
    parser.add_argument("--data_loader", help="data_loader.py", default="./data_loader.py")
    args = parser.parse_args()
    # LANG_ID = args.lang
    MODEL_ID = args.model_name_or_path
    SAMPLES = 10

    test_dataset = load_dataset(args.data_dir, split=f"test")
