...
_DATA_URL = "http:nas/fsdownload/Ob4T6DMeZ/audio.tar.gz"
class CliveDataset(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        splits = {
            "train": "http://nas/fsdownload/4faxyD9oZ/train_split.tar",
            "test": "http://nas/fsdhttp:ownload/3Gwtzc9i6/test_split.tar",
            "validation": "http://nas/fsdownload/1MMQNwoQB/validation_split.tar"
        }
        metadata_paths = {}
        for split in splits:
